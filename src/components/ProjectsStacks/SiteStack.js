...
const SiteStack = () => {
    return (
        ...
        >
          ...
          {/* Sixth picture */}
          <Carousel.Item>
            <img className="d-block w-100" src={mongoLogo} alt="Mongo Logo" />
            <Carousel.Caption>
              <h5>MongoDB</h5>
            </Carousel.Caption>
          </Carousel.Item>
          {/* Seventh picture */}
          <Carousel.Item>
            <img className="d-block w-100" src={mongooseLogo} alt="Mongoos Logo" />
            <Carousel.Caption>
              <h5>Mongoose ORM</h5>
            </Carousel.Caption>
          </Carousel.Item>
          {/* Eight picture */}
          <Carousel.Item>
            <img className="d-block w-100" src={postgresLogo} alt="postgres Logo" />
            <Carousel.Caption>
              <h5>PostgresSQL</h5>
            </Carousel.Caption>
          </Carousel.Item>
